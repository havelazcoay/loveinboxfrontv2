...
import '../hojas-de-estilo/TermsAndConditions.css';
...
export const TermsAndConditions= () => {
  ...
  return(
    <div className="termsandconditions-main">
      <div className="termsandconditions-sub-main">
        <div>
          <div className="termsandconditions-imgs">
            <div className="termsandconditions-container-image">
              <img src={LoveInBoxWeb} alt="LoveInBoxWeb" className="termsandconditions-profile"/>
            </div>
          </div>
          <div>
            <div>
            ...
            <label>Términos y Condiciones
                ...
                No dude en contactarnos si tiene alguna pregunta.
                 ...
                 -A través de este enlace:  https://loveinbox1.herokuapp.com
                </label>
            </div>
            <div className="termsandconditions-space">
             <button onClick ={() => navigate("/Register")} className="termsandconditions-button">Aceptar</button>
            </div>
            <div className="termsandconditions-space">
             <button onClick ={() => navigate("/Register")} className="termsandconditions-button">Cancelar</button>
            </div>
          </div>
        </div>
      </div>
